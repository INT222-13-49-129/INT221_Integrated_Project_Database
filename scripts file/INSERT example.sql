...
INSERT INTO `cfandb`.`Ingredients` (`Ingredientsid`, `Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`) VALUES ('201', 'Tomato', '50', 'gram', 'Red vegetable', 'Vegetable');
INSERT INTO `cfandb`.`Ingredients` (`Ingredientsid`, `Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`) VALUES ('202', 'Potato', '100', 'gram', 'Brown vegetable', 'Vegetable');
INSERT INTO `cfandb`.`Ingredients` (`Ingredientsid`, `Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`) VALUES ('203', 'Onion', '50', 'gram', 'Cream vegetable', 'Vegetable');
...
INSERT INTO `cfandb`.`foodmenu_has_Ingredients` (`Foodmenu_Foodmenuid`, `Ingredients_Ingredientsid`, `Totalunit`, `Totalkcal`) VALUES ('401', '201', '5', '212');
INSERT INTO `cfandb`.`foodmenu_has_Ingredients` (`Foodmenu_Foodmenuid`, `Ingredients_Ingredientsid`, `Totalunit`, `Totalkcal`) VALUES ('402', '202', '10', '309');
INSERT INTO `cfandb`.`foodmenu_has_Ingredients` (`Foodmenu_Foodmenuid`, `Ingredients_Ingredientsid`, `Totalunit`, `Totalkcal`) VALUES ('403', '203', '15', '150');
...
INSERT INTO `cfandb`.`Ingredientsreq` (`Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`, `Request_Requestid`) VALUES ('Tomato', '212', 'g', 'gram', 'Vegetable', '601');
INSERT INTO `cfandb`.`Ingredientsreq` (`Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`, `Request_Requestid`) VALUES ('Potato', '309', 'g', 'gram', 'Vegetable', '602');
INSERT INTO `cfandb`.`Ingredientsreq` (`Ingredientsname`, `kcalpunit`, `Unit`, `Descriptionunit`, `Ingredientstype`, `Request_Requestid`) VALUES ('Onion', '150', 'g', 'gram', 'Vegetable', '603');
