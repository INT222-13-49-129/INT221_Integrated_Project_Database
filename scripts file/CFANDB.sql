...
-- Table `cfandb`.`Pin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cfandb`.`Pin` ;

CREATE TABLE IF NOT EXISTS `cfandb`.`Pin` (
  ...
  `User_Userid` INT NOT NULL,
  PRIMARY KEY (`Pinid`),
  INDEX `fk_Pin_User1_idx` (`User_Userid` ASC) VISIBLE,
  CONSTRAINT `fk_Pin_User1`
    FOREIGN KEY (`User_Userid`)
    REFERENCES `cfandb`.`User` (`Userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
